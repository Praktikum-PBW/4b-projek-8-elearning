        ...
        <div class="container">
            <div class="row justify-content-center pt-5" data-aos="fade-up">
                <div class="col-12 col-lg-6 mb-5">
                    <h5 class="display-5 fw-bold">Belajar Mudah Dimana Saja & Kapan Saja dengan <span class="logo fw-bold">Guruku</span></h5>
                    ...
                    <button class="btn bt btn-lg mt-4"><a href="back/siswa/register.php" class="text-decoration-none">Daftar Sekarang</a></button>
                </div>
